...
export const slang: SlangEntry[] = [
  ...
  { word: "ice",                   desc: "ダイヤモンドや宝石、とくに氷のように光る高価なジュエリーを指すスラング。ice-rockin は「ジュエリーを着けて光らせている」。動詞 ice out で「宝石で埋め尽くす」" },
  { word: "snitch",               desc: "警察や当局に仲間の情報を漏らす「密告者・タレコミ屋」。動詞なら「チクる・タレこむ」。ストリートの掟でもっとも嫌われる行為で、Stop Snitchin（チクるな）という標語まである" },
  { word: "dough",                 desc: "本来は「パン生地」。金を食べものに言い換えるスラングの一つで「金・現金」を指す。bread（パン）、cheddar（チーズ）と同じ発想。dough snatcher なら「金をかっさらう者」" },
  { word: "one love",              desc: "別れ際や仲間への「達者でな・愛してるぜ・敬意を込めて」を表す挨拶。レゲエ／ラスタファリ由来で、ヒップホップでは連帯と別れの言葉として定着した。Nasの同名曲でも有名" },
  ...
  { word: "bring the ruckus",      desc: "「大暴れする・場を荒らしにいく」。ruckusは「騒ぎ・大騒動」で、bring the ruckusで「殴り込みをかける・思い切りかき回す」の意。Wu-Tang Clanの同名曲でも知られる、90sNYの気合いを表す常套句" },
  { word: "snake",                 desc: "「裏切り者・こっそり出し抜くやつ」。蛇のように音もなく忍び寄り噛みつく人物像から。動詞で「snake（人を出し抜く・かすめ取る）」とも使う" },
  { word: "school",                desc: "動詞で「（相手を）教え込む・叩き込む・格の違いを思い知らせる」。teachの砕けた言い方で、バトルでは『格上が格下に一方的に教育してやる＝完膚なきまでに打ち負かす』というニュアンスになる" },
  { word: "illest",               desc: "ill（ヤバい・最高にイカした）の最上級で「最強・最高にイケてる」。もとは『病んだ』の意だったillが90sには裏返って最上級の褒め言葉になった、ヒップホップ特有の反転スラング" },
  { word: "sensi",                 desc: "sensimilla（種のない高品質な大麻）の略。ジャマイカのラスタ文化由来の呼び名で、上物のマリファナを指す" },
  ...
  { word: "gat",                   desc: "拳銃を指すスラング。1920年代のギャング御用達だった機関銃 Gatling gun（ガトリング砲）を縮めた古い隠語で、以後ハンドガン全般を指す言葉として定着した。keep a gat＝銃を携帯している" },
  { word: "raw",                    desc: "本来は「生の・未加工の」。ストリート文脈では精製済みでカットしていないコカイン、つまり純度の高いブツを指すことが多い。転じてラップの評価語としては「剥き出しで生々しい・飾らず攻めている」の褒め言葉にもなる" },
  { word: "Jake",                   desc: "警察官を指すニューヨーク発の隠語。the Jakes / Five-O などと並んで使われる。語源は諸説あるが、少なくとも1980〜90年代のNYストリートでは警官＝Jakeとして通っていた" },
  { word: "clap",                   desc: "本来は「手を叩く・拍手」。銃声のパンという破裂音になぞらえて、ストリートでは「発砲する・撃つ」を意味する動詞になった。get to clappin'＝撃ち始める、clap back は「撃ち返す／言い返す」" },
  { word: "strong-arm",            desc: "arm（腕）に strong（強い）を付けた複合語で、動詞として「腕力で押さえ込む・力ずくで奪う・脅して従わせる」。strong-arm robbery は武器を使わず腕力だけで行う強盗を指す法律用語でもある" },
  { word: "open",                  desc: "「開いている」が字義だが、AAVEでは「相手にすっかり夢中・骨抜きにされている」の意で使う形容詞。have someone open＝誰かを夢中にさせる、I'm open＝首ったけだ、のように使う" },
  { word: "gangsta lean",          desc: "運転席で片手をハンドルに、体を助手席側へ深く傾けて座る乗り方のこと。1990年代の西海岸・南部のローライダー文化に根ざしたポーズで、余裕と貫禄を見せる姿勢の記号として歌詞に登場する" },
